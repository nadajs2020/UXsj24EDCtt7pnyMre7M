<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{-- @if (Request::is('admin/associations*')) open @endif --}}
            ...
            <li class="nav-item"><a href="{{ route('admin.maincategories') }}"><i class="la la-group"></i>
                    ...
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\Main_categorie::count() }}</span>
                </a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="navbar-semi-dark.html" data-i18n="nav.navbars.nav_semi">Navbar
                            Semi
                            Dark</a>
                    </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-puzzle-piece"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-menu-template/layout-dark.html"
            ...
            <li class=" nav-item"><a href="changelog.html"><i class="la la-copy"></i><span
                        class="menu-title" data-i18n="nav.changelog.main">Changelog</span><span
            ...
            <li class=" nav-item"><a href="#"><i class="la la-briefcase"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="project-tasks.html"
                            data-i18n="nav.project.project_tasks">Project
                            Task</a>
                    </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-search"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="search-page.html"
                            data-i18n="nav.search_pages.search_page">Search
                            Page</a>
                    </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-warning"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="error-400.html" data-i18n="nav.error_pages.error_400">Error
                            400</a>
                    </li>
